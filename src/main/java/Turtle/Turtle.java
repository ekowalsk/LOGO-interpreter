...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    private static void init()
    {
        ...
        textField.setAlignmentY(SwingConstants.BOTTOM);
        textField.setPreferredSize(new Dimension(450,150));
        draw.add(textField);
        ...
        enter.addActionListener(new ActionListener()
        {
            ...
            {
                StringSource s = new StringSource(textField.getText());
                ...
                {
                    textField.setText(textField.getText() + ' ' + exc.getMessage());
                }
            }
        });
        enter.setBounds(200, 200, 100, 30);
        enter.setAlignmentX(SwingConstants.BOTTOM);
        draw.add(enter);
        try {
